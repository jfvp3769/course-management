...
let academicCalendarEvents = JSON.parse(JSON.stringify(DEFAULT_DATA.academicCalendarEvents || DEFAULT_DATA.msuCalendarEvents));
let msuCalendarEvents = academicCalendarEvents;
